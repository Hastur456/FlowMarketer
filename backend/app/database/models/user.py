...
class User(SQLAlchemyBaseUserTableUUID, Base):
    """
    Уже содержит id (UUID), email, hashed_password, 
    is_active, is_superuser, is_verified.
    """
    
    # Ваши дополнительные поля (пример из закомментированного кода)
...
class SQLAlchemyUserDatabase(SQLAlchemyUserDatabaseGeneric):
    """Кастомный адаптер базы данных для расширенных методов"""
